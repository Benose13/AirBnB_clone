...
class TestBaseModel(unittest.TestCase):
    ...
    def test_to_dict_includes_updated_at(self):
        ...
        attribute in the dictionary."""
        dict_cp = self.base_model.to_dict()
        self.assertIn("updated_at", dict_cp)
        self.assertIsInstance(dict_cp["updated_at"], str)
    ...
    def test_to_dict_excludes_methods(self):
        ...
        dict_cp = self.base_model.to_dict()
        self.assertNotIn("save", dict_cp)
        self.assertNotIn("__str__", dict_cp)
